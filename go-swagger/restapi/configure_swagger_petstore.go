...
import (
	...
	"go-swagger/restapi/operations/pet"
	"go-swagger/restapi/operations/store"
	"go-swagger/restapi/operations/user"
)

//go:generate swagger generate server --target ../../go-swagger --name SwaggerPetstore --spec ../../swagger/swagger.yml --principal interface{}
